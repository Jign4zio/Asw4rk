...
if DBType == '1':
    ...
    Output = SIDDB+"_"+NombreCliente+".log"
...
if DBType == '2':
    ...
    print (str(MinCrontab)+" "+Horario[NombreCliente][3:5]+" * * * tail -10000 /hana/shared/"+SIDDB+"/HDB10/hostname_servidor/trace/backup.log > /root/BKmon/backup_"+SIDDB+"_"+NombreCliente+".log\n")
    PathLog = "/root/BKmon/backup_"+SIDDB+"_"+NombreCliente+".log"
